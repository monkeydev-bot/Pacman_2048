def gameplay(n,value_max):
    ...
    while get_value_player(grid)<value_max:
        ...
        if move_pos_player(grid,pos_player,command)!=move_pos_ennemi(pos_player,pos_objectif,pos_ennemi) and move_pos_player(grid,pos_player,command)!=pos_objectif and (move_pos_player(grid,pos_player,command),move_pos_ennemi(pos_player,pos_objectif,pos_ennemi))!=(pos_ennemi,pos_player):
            grid=move_player(grid,pos_player,command)
            grid=move_ennemi(grid,pos_player,pos_objectif,pos_ennemi)
            
            print(grid_to_string(grid))
            
        elif move_pos_player(grid,pos_player,command)==move_pos_ennemi(pos_player,pos_objectif,pos_ennemi) or (move_pos_player(grid,pos_player,command),move_pos_ennemi(pos_player,pos_objectif,pos_ennemi))==(pos_ennemi,pos_player):
            return('game over')
...
def move_ennemi(grid,pos_ennemy,pos_objectif,commande):
    old_abs_ennemy, old_ord_ennemy=pos_ennemy
    new_abs_ennemy, new_ord_ennemy=move_pos_ennemi(pos_ennemy,pos_objectif,commande)
